...
insert  into offices(officeCode,city,phone,addressLine1,addressLine2,state,country,postalCode,territory) values ('4','Paris','+33 14 723 4404','43 Rue Jouffroy Dabbans',NULL,NULL,'France','75017','EMEA');
...
insert  into employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1102,'Bondur','Gerard','x5408','gbondur@classicmodelcars.com','4',1056,'Sale Manager insert(EMEA)');

insert  into employees(employeeNumber,lastName,firstName,extension,email,officeCode,reportsTo,jobTitle) values (1143,'Bow','Anthony','x5428','abow@classicmodelcars.com','1',1056,'Sales Manager insert (NA)');
...
insert  into customers(customerNumber,customerName,contactLastName,contactFirstName,phone,addressLine1,addressLine2,city,state,postalCode,country,salesRepEmployeeNumber,creditLimit) values (276,'Annas Decorations, Ltd','O Hara','Anna','02 9936 8555','201 Miller Street','Level 15','North Sydney','NSW','2060','Australia',1611,107800.00);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10112,to_date('2003-03-24','YYYY-MM-DD'),to_date('2003-04-03','YYYY-MM-DD'),to_date('2003-03-29','YYYY-MM-DD'),'Shipped','Customer requested that ad materials insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (such as posters, pamphlets) be included in the shippment',144);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10164,to_date('2003-10-21','YYYY-MM-DD'),to_date('2003-10-30','YYYY-MM-DD'),to_date('2003-10-23','YYYY-MM-DD'),'Resolved','This order was disputed, but resolved on 11/1/2003; Customer doesnt like the colors and precision of the models.',452);

insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10165,to_date('2003-10-22','YYYY-MM-DD'),to_date('2003-10-31','YYYY-MM-DD'),to_date('2003-12-26','YYYY-MM-DD'),'Shipped','This order was on hold because customerss credit limit had been exceeded. Order will ship when payment is received',148);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10218,to_date('2004-02-09','YYYY-MM-DD'),to_date('2004-02-16','YYYY-MM-DD'),to_date('2004-02-11','YYYY-MM-DD'),'Shipped','Customer requested that ad materials insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (such as posters, pamphlets) be included in the shippment',473);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10316,to_date('2004-11-01','YYYY-MM-DD'),to_date('2004-11-09','YYYY-MM-DD'),to_date('2004-11-07','YYYY-MM-DD'),'Shipped','Customer requested that ad materials insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (such as posters, pamphlets) be included in the shippment',240);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10327,to_date('2004-11-10','YYYY-MM-DD'),to_date('2004-11-19','YYYY-MM-DD'),to_date('2004-11-13','YYYY-MM-DD'),'Resolved','Order was disputed and resolved on 12/1/04. The Sales Manager was involved. Customer claims the scales of the models dont match what was discussed.',145);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10367,to_date('2005-01-12','YYYY-MM-DD'),to_date('2005-01-21','YYYY-MM-DD'),to_date('2005-01-16','YYYY-MM-DD'),'Resolved','This order was disputed and resolved on 2/1/2005. Customer claimed that container with shipment was damaged. FedExs investigation proved this wrong.',205);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10386,to_date('2005-03-01','YYYY-MM-DD'),to_date('2005-03-09','YYYY-MM-DD'),to_date('2005-03-06','YYYY-MM-DD'),'Resolved','Disputed then Resolved on 3/15/2005. Customer doesnt like the craftsmaship of the models.',141);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10415,to_date('2005-05-09','YYYY-MM-DD'),to_date('2005-05-20','YYYY-MM-DD'),to_date('2005-05-12','YYYY-MM-DD'),'Disputed','Customer claims the scales of the models dont match what was discussed. I keep all the paperwork though to prove otherwise',471);
...
insert  into orders(orderNumber,orderDate,requiredDate,shippedDate,status,comments,customerNumber) values (10417,to_date('2005-05-13','YYYY-MM-DD'),to_date('2005-05-19','YYYY-MM-DD'),to_date('2005-05-19','YYYY-MM-DD'),'Disputed','Customer doesnt like the colors and precision of the models.',141);
