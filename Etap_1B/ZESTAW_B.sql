...
VARIABLE  START_TIME_ZESTAW_B NUMBER;
EXEC :START_TIME_ZESTAW_B := EXTRACT(SECOND FROM SYSTIMESTAMP);
...
VARIABLE  TIME_FOR_ZESTAW_B NUMBER;
EXEC :TIME_FOR_ZESTAW_B := EXTRACT(SECOND FROM SYSTIMESTAMP)-:START_TIME_ZESTAW_B;

PRINT TIME_FOR_ZESTAW_B;